...
- Plugin package: `oh-my-opencode-slim@2.0.0-beta.4`
- Plugin config schema: `https://unpkg.com/oh-my-opencode-slim@2.0.0-beta.4/oh-my-opencode-slim.schema.json`
...
- 启用插件：
  ...
  - `oh-my-opencode-slim@2.0.0-beta.4`
...
```bash
bunx oh-my-opencode-slim@2.0.0-beta.4 doctor
```
...
- 需要更稳定时，可把 package 从 beta pin 到 release 版，例如 `oh-my-opencode-slim@2.0.0-beta.4`，同时确认 V2 beta 环境变量是否仍需要。
