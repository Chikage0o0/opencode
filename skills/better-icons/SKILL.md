---
name: better-icons
description: 'Use when adding, searching, retrieving, or syncing icons. Triggers on "icon", "Iconify", "SVG icon", "lucide", "mdi", "heroicons", or requests to pick an icon. Uses the better-icons CLI/MCP to search 200+ Iconify libraries and return SVGs.'
---
