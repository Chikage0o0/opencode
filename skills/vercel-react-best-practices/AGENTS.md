...
3. [Server-Side Performance](#3-server-side-performance) — **HIGH**
   - 3.1 [Authenticate Server Mutations Like Public Endpoints](#31-authenticate-server-mutations-like-public-endpoints)
   ...
   - 3.8 [Keep Post-Response Work Non-Blocking](#38-keep-post-response-work-non-blocking)
