...
Comprehensive performance optimization guide for React applications, maintained by Vercel. Contains 64 rules across 8 categories, prioritized by impact to guide automated refactoring and code generation.
...
- `server-auth-actions` - Authenticate server mutations like public endpoints
...
- `server-after-nonblocking` - Keep post-response work non-blocking
