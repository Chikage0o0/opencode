---
name: web-perf
description: 'Use when auditing, profiling, debugging, or optimising page load performance, Lighthouse scores, Core Web Vitals, or site speed. Triggers on "slow page", "poor LCP/INP/CLS", "performance audit", "why is the page heavy", Lighthouse, or render-blocking/network/cache concerns. Uses Chrome DevTools MCP trace + network + a11y snapshot, then codebase analysis; checks web.dev/Chrome docs for current thresholds.'
---
